...
namespace BpEmuMetroForms.Brainpack.Communication
{
    ...
    public class ServerListener
    {
        ...
        public bool StartServer(int vPortNumber)
        {
            PortNumber = vPortNumber;
            UpdateUi("Starting Server");
            IPAddress vIp = IPAddress.Parse(NetworkUtils.GetLocalIpAddress());
            ...
            {
                throw new ArgumentOutOfRangeException("ServerListener_StartServer_Port_number_is_invalid", vArgument);
            }
            try
            {
